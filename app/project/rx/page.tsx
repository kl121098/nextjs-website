...
const page = () => {
  return (
    <div>
      <div className="min-h-screen bg-gradient-to-r from-[#008037] to-[#095FBA] p-4 mt-12">
        <div className="lg:flex ">
          <div className="lg:w-1/2 lg:ml-24 mt-12">
            ...
            <img src="../rx logo.svg" className="mt-28" />
      ...
      <div className="lg:ml-24 lg:mr-24 mt-20 p-4">
        ...
        <h2 className="text-5xl font-bold mt-6">
          What is <span className="text-[#008037]">RX?</span>
        </h2>
        <div className="lg:flex mt-16 mb-16 lg:space-x-10">
          <div className="lg:w-1/3">
            <img src="../projectrx.svg" className="" />
          </div>
      ...
      <div className="min-h-screen bg-gradient-to-r from-[#008037] to-[#095FBA] lg:pl-28 pt-16 pb-16 p-6">
      ...
      <div className="flex justify-center pt-16 lg:space-x-4">
          <h2 className="text-[#008037] font-bold text-5xl mt-3">Design Process</h2>
          <img src="../designrx.svg" className="h-20 w-20" />
        </div>
      ...
      <div className="bg-image4 ">
        <h2 className="text-[#008037] pt-16 font-bold text-5xl text-center">Design Screens</h2>
        <div className="flex justify-center mt-24">
            <img src="../Design screen 1.svg"/>
        </div>
        <div className="lg:flex justify-between mt-16">
            <img src="../Design screen 2.svg" className="lg:ml-36"/>
            <img src="../Design screen 3.svg"/>
        </div>
      </div>
    </div>
  );
