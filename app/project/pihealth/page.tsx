...
const page = () => {
  return (
    <div>
      <div className="min-h-screen bg-gradient-to-b from-[#008036] to-[#0A5FBA] p-4 mt-12">
        <div className="lg:flex ">
          <div className="lg:w-1/2 lg:ml-24 mt-12">
            ...
            <img src="../logopi.svg" className="mt-28" />
      ...
      <div className="lg:ml-24 lg:mr-24 mt-20 p-4">
        ...
        <h2 className="text-5xl font-bold mt-6">
          What is <span className="text-[#008036]">Pi</span>-<span className="text-[#0A5FBA]">Health</span>?
        </h2>
      ...
      <div className="min-h-screen bg-gradient-to-r from-[#095FBA] to-[#008036] lg:pl-28 pt-16 pb-16 p-6">
      ...
      <div className="flex justify-center pt-16 lg:space-x-4">
          <h2 className="text-[#125D97] font-bold text-5xl mt-3">Design Process</h2>
          <img src="../designpi.svg" className="h-20 w-20" />
        </div>
      ...
      <div className="bg-image3">
        <h2 className="text-[#125D97] pt-16 font-bold text-5xl text-center">Application Screens</h2>
